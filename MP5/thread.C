...
/*--------------------------------------------------------------------------*/
/*
  The handle to the scheduler is required, especially to call to yeild the CPU to
  next elligble thread.
*/
...
/*
  Thread Destructor. Frees the stack occupied by the Thread.
*/
Thread::~Thread()
{
  delete[] stack;
